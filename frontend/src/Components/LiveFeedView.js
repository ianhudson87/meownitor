// cite: https://github.com/awslabs/amazon-kinesis-video-streams-webrtc-sdk-js/issues/45#issuecomment-629308809
import React from 'react';
import AWS from "aws-sdk";
import { SignalingClient, sup } from 'amazon-kinesis-video-streams-webrtc';
...
class LiveFeedView extends React.Component {
    constructor(props) {
        ...
        console.log("here", window.KVSWebRTC)
    }
    ...
    async componentDidMount() {
        console.log(this.props.formValues.endpoint)
        // Create KVS client
        ...
        while(! window.KVSWebRTC){
            await this.sleep(100)
        }
        console.log(window.KVSWebRTC)
    ...
    render() {
        return (
          <video ref={this.videoRef} style={{width: '100%', minHeight: '500px', maxHeight: '100px', position: 'relative' }} controls autoPlay playsInline />
        )
    }
}
